...
<?php include "control-inicio.php"; ?>
	<?php include "side-bar.php"; ?>
        ...
        $sql = "SELECT * FROM `guardia` WHERE `DNI` = $DNIGuardia";
...
<form name="modificar" action="inactivos-2.php" method="get">
        ...
        <table>
            ...
            <tr>
                <td>Nombre </td><td><input type="text" name="Nombre" value="<?php echo $m["Nombre"]; ?>" readonly></td>
            </tr>
            <tr>
                <td>Apellido </td><td><input type="text" name="Apellido" value="<?php echo $m["Apellido"]; ?>" readonly></td>
            </tr>
            <tr>
                <td>Telefono </td><td><input type="text" name="Telefono" value="<?php echo $m["Telefono"]; ?>" readonly></td>
            </tr>
            <tr>
                <td>Email </td><td><input type="text" name="Email" value="<?php echo $m["Email"]; ?>" readonly></td>
            </tr>
            <tr>
                <td>Domicilio </td><td><input type="text" name="Domicilio" value="<?php echo $m["Domicilio"]; ?>" readonly></td>
            </tr>
            <tr>
